...
import { Calendar, Search, User, LogOut, Menu } from 'lucide-react';
...
export function PatientLayout() {
  ...
  const navItems = [
    { label: language === 'en' ? 'Find Doctors' : 'ابحث عن الأطباء', to: '/doctors', icon: Search },
    { label: language === 'en' ? 'My Appointments' : 'مواعيدي', to: '/my-appointments', icon: Calendar },
    { label: language === 'en' ? 'My Profile' : 'ملفي', to: '/profile', icon: User },
  ];
